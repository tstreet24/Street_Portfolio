...
* The baseline model, which predicts the prior day's price, generally outperformed the LSTM model. <img src="images/dl_lstm_eval" width="400" alt="Image description">
...
* The web application runs effectively and quickly. <img src="images/dl_demo_1.png" width="400" alt="Image description"> <img src="images/dl_demo_2.png" width="400" alt="Image description">
...
## Actions
- Use mixed-integer modeling to perform k-means and k-medoids clustering. <img src="images/ml_formu_kmeans.png" width="400" alt="Image description">)  <img src="images/ml_formu_kmed.png" width="400" alt="Image description">
...
## Results
- K-means and k-medoids clustering can be developed into optimization models using mixed-integer techniques. The models struggle to converge or improve the warm start solution as dataset size increases and when Euclidean distance is used. <img src="images/ml_clust_results.png" width="400" alt="Image description">
